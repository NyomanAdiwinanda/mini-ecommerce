<template>
  <div class="main-block">
    <div class="left-part">
      ...
      <h1>EDIT BANNER</h1>
      <p class="description">Submit the form to edit the existing banner in your store</p>
    </div>
...
export default {
  data () {
    return {
      title: this.$store.state.editBanner.title,
      status: this.$store.state.editBanner.status,
      image_url: this.$store.state.editBanner.image_url,
